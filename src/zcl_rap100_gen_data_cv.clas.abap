CLASS zcl_rap100_gen_data_CV DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_CV IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'CV',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravCV.
*    DELETE FROM zrap100_dtravCV.

    "insert travel demo data
    INSERT zrap100_atravCV  FROM (
        SELECT
